...
From Claude Code plugins to automotive diagnostics to AI SDR automation, I focus on tools that work. Helping fast-growing companies solve their most expensive automation challenges—from out-of-control costs and security compliance to workflow optimization. **All so you can focus on shipping your product.**
...
- Secure per-tenant API key storage with GCP Secret Manager
- 7 serverless functions for orchestration
- Auto-scaling with built-in observability

**Tech Stack:** Gemini 2.5 Flash, Vertex AI, Firebase, GCP, Cloud Functions
...
### AI/ML & Reasoning
![Claude](https://img.shields.io/badge/Claude-Anthropic-191919?style=flat-square)
![Gemini](https://img.shields.io/badge/Gemini-Google_Vertex_AI-4285F4?style=flat-square)
![OpenAI](https://img.shields.io/badge/OpenAI-GPT-412991?style=flat-square)

- **Claude (Anthropic)** - Primary agent framework
- **Gemini (Google Vertex AI)** - Production ML workloads
- **OpenAI GPT** - Multi-model strategies
- **RAG Pipelines & Vector Stores**
- **Vertex AI Agent Engine** - Multi-agent orchestration
...
Clean AI agent implementation - production-ready autonomous agent framework. Python-based with proper architecture patterns.
...
**Tech:** Shell, n8n, Automation

#### [news-pipeline-n8n](https://github.com/jeremylongshore/news-pipeline-n8n)
Automated daily news monitoring and topic analysis. Transform scattered news sources into structured intelligence briefs. AI-powered analysis for decision makers.

**Tech:** n8n, AI Analysis, Automation
...
2. **Automation Design** - n8n, Netlify Functions, Vertex AI workflows replacing manual tasks
3. **Agent Deployment** - Claude & OpenAI agents backed by docs, vector stores, safety rails
4. **Data Pipelines** - BigQuery, Firebase, Postgres with telemetry and access control
...
![Jeremy's GitHub Stats](https://github-readme-stats.vercel.app/api?username=jeremylongshore&show_icons=true&theme=github_dark&hide_border=true&count_private=true&include_all_commits=true)
...
![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=jeremylongshore&layout=compact&theme=github_dark&hide_border=true&langs_count=8)
...
- **AI Standards**: Contributing to emerging agent framework patterns
- **Technical Writing**: 65+ posts on AI implementation and automation
...
**Need automation, rapid prototyping, or full product?** Let's talk about measurable wins, not hype.
